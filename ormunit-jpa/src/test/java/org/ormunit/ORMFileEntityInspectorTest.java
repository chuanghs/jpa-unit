...
public class ORMFileEntityInspectorTest {

    @Mock
    private JPAEntityInspector backupEntityInspector;

    private ORMFileEntityInspector ormFileEntityInspector;
    ...
    public void before() {
        ...
        ormFileEntityInspector = spy(new ORMFileEntityInspector(entityMappings, backupEntityInspector));
    }
